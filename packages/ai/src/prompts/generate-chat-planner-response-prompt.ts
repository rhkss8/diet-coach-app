  ...
  const textContent = JSON.stringify(
    {
      ...
      rules: [
        ...
        "If the user asks for exercise, prefer exercise_plan_suggestion unless they clearly want to revise an existing plan.",
        ...
        "Use plan_revision_suggestion only when currentPlan exists and the user wants existing plan items changed.",
        "Plan revisions may target today, a past date correction, a future date such as tomorrow, or a week-level range if the user's message names that scope.",
        "For future or week-level revisions, put future-dated changed items in updatedFutureItems and keep updatedTodayItems for today/past changed items only.",
        "Set affectedDate to the first changed plan date, not always todayDate.",
