...
```txt
Product intent -> reference scan -> visual territories -> direction decision -> wireframes -> high-fidelity screen plan -> implementation -> design QA
```
...
## Phase 6: High-Fidelity Screen Plan
