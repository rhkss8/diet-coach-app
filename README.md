...
계획이 깨졌을 때 포기하지 않고 오늘 기준으로 다시 이어가게 돕는 다이어트 플래너 MVP입니다.

핵심 루프는 다음 흐름입니다.

```text
온보딩 -> 첫 7일 플랜 생성 -> 플랜 승인 -> 오늘 플랜 실행 -> 오늘 계획 조정 -> 조정안 승인 -> 계속 진행
```
...
개발, 수동 QA, 테스트, 웹 빌드 준비는 완료되어 있습니다.
...
이 작업은 실제 tester 초대와 배포 결정이 필요합니다.
