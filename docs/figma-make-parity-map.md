...
1. Match the compact top area, date, serif title, progress rail, meal/exercise section headers, cards, skip pills, and bottom coral recovery CTA.
2. Confirm the design matches the user-approved Image #1 compact version, not the earlier oversized Image #2 version.
