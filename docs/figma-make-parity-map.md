...
1. Match the seven Figma Make reason tiles, selected coral styling, and icon set.
2. Resolve the extra optional note card by either matching Figma Make exactly or documenting the product reason to keep it.
